...
The rest of this page is rendered by ClojureScript found in the `src/cljs/webapp/core.cljs` file.
...
* Let `mount` know to start the database connection by `require`-ing `webapp.db.core` in some other namespace.
